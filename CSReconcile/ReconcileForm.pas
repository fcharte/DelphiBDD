...
constructor TfrmReconcile.CreateForm(DataSet: TDataSet;
...
procedure TfrmReconcile.InitDataFields;
var
  I: Integer;
  FD: PFieldData;
  V: Variant;
...
procedure TfrmReconcile.InitUpdateData(HasCurValues: Boolean);
var
  FColCount: Integer;
begin
  FColCount := 1;
...
procedure TfrmReconcile.InitReconcileActions;
...
procedure TfrmReconcile.DisplayFieldValues(Sender: TObject);
var
  I: Integer;
  CurRow: Integer;
...
procedure TfrmReconcile.SetFieldValues(DataSet: TDataSet);
var
  I: Integer;
begin
  for I := 0 to FDataFields.Count - 1 do
...
procedure TfrmReconcile.AdjustColumnWidths;
var
  NewWidth, I: Integer;
begin
  with UpdateData do
...
procedure TfrmReconcile.FormCreate(Sender: TObject);
begin
...
procedure TfrmReconcile.FormDestroy(Sender: TObject);
var
  I: Integer;
begin
...
procedure TfrmReconcile.UpdateDataSetEditText(Sender: TObject; ACol,
...
procedure TfrmReconcile.UpdateDataSelectCell(Sender: TObject; Col,
